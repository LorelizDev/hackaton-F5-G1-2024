    ...
    const data = [
      ...
      return (
        <>
          <div className='flex flex-col justify-center max-w-96 mx-auto'>
            ...
            <div>
              ...
              <div className=' flex gap-4 '>
                {moods.map((mood) => (
                  <div key={mood.name}>
                    <button className={`${mood.color} m-2 p-2 rounded-xl text-white text-4xl`}>
                      {mood.icon}
                    </button>
          ...
          <div className='flex items-center max-w-96 mx-auto my-6'>
            <SearchBar onSearch={handleSearch} />
            <button className='bg-medium rounded-full w-8 h-8'>
